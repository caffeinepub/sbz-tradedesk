...
export class Backend implements backendInterface {
    ...
    async createDocument(arg0: DocumentInput): Promise<string> {
        if (this.processError) {
            try {
    ...
    async listUserDocuments(arg0: Principal): Promise<Array<Document>> {
        if (this.processError) {
            try {
                const result = await this.actor.listUserDocuments(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchDocumentsByField(arg0: string, arg1: string): Promise<Array<Document>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchDocumentsByField(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDocument(arg0: string, arg1: DocumentInput): Promise<void> {
        if (this.processError) {
            try {
